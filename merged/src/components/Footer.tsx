          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-2.5 pt-2">
              <button
                ...
                className="px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-[11px] font-game font-bold text-white transition-all flex items-center gap-1.5 shadow-[0_0_15px_rgba(168,85,247,0.3)] cursor-pointer"
              >
                <span className="material-symbols-outlined text-sm text-amber-300">movie</span>
                WATCH 3D REVEAL
              </button>
              <a
                href={discordUrl}
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-[#0e1224] border border-purple-500/30 text-[11px] font-game font-bold text-amber-400 hover:text-amber-300 hover:border-amber-400/50 transition-all flex items-center gap-1.5"
              >
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-[#0e1224] border border-purple-500/30 text-[11px] font-game font-bold text-purple-300 hover:text-white hover:border-purple-400/50 transition-all flex items-center gap-1.5"
              >

...
export const FruitSlot: React.FC<FruitSlotProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-7 h-7 sm:w-9 sm:h-9 rounded-lg sm:rounded-xl bg-purple-950/40 border border-purple-500/30 flex items-center justify-center mb-0.5 sm:mb-1 group-hover:scale-105 transition-transform shrink-0">
          <span className="material-symbols-outlined text-purple-300 text-lg sm:text-2xl">
            {fruit.icon || 'star'}
          </span>
        </div>

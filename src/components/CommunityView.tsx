        ...
        <div className="relative overflow-hidden rounded-3xl bg-[#0a0d1f] border border-purple-500/30 p-8 sm:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.8)] text-center">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <div className="relative mb-4">
              <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-2xl p-1 bg-gradient-to-tr from-[#7c3aed] via-[#a855f7] to-[#fbbf24] shadow-[0_0_35px_rgba(168,85,247,0.5)]">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              ...
              <button
                ...
                className="px-5 py-3 rounded-xl bg-[#0e1224] hover:bg-[#161b36] border border-purple-500/40 text-purple-200 font-game font-bold text-xs uppercase tracking-wider transition-all duration-200 flex items-center gap-2 hover:border-purple-400 cursor-pointer"
              >

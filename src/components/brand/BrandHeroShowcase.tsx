  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 pt-3">
            {onOpenCalculator && (
              <button
                ...
                className="px-6 py-3 rounded-2xl bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-400 hover:to-yellow-400 text-black font-game font-black text-xs uppercase tracking-wider transition-all duration-200 flex items-center gap-2 shadow-[0_0_25px_rgba(245,158,11,0.4)] hover:scale-105 active:scale-95 cursor-pointer"
              >
        ...
        {/* Right 3D Shield Crest Badge */}
        <div className="relative shrink-0">
          {/* Glow Aura */}
          <div className="absolute -inset-4 bg-gradient-to-tr from-purple-600/40 via-amber-500/30 to-indigo-600/40 rounded-full blur-2xl group-hover:blur-3xl opacity-70 pointer-events-none" />

          {/* Crest Container */}
          <div className="relative w-40 h-40 xs:w-48 xs:h-48 sm:w-56 sm:h-56 md:w-60 md:h-60 rounded-2xl sm:rounded-3xl p-1 sm:p-1.5 bg-gradient-to-tr from-[#7c3aed] via-[#a855f7] to-[#fbbf24] shadow-[0_0_40px_rgba(124,58,237,0.5)]">
